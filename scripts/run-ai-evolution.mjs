...
const configs = {
  smoke: { populationSize: 16, generations: 2, evaluationSeeds: ['smoke-001', 'smoke-002', 'smoke-003'], opponentsPerGenome: 3, matchesPerOpponent: 3, absoluteMaxTicks: 1500, tieBreakerRules: ['hp_percentage', 'total_damage_dealt', 'total_assets'], eliteCount: 2, hallOfFameOpponentCount: 2, mutationRatePermille: 60, crossoverRatePermille: 600, mutationSigmaInitial: 50, mutationSigmaDecay: 0.98, tournamentSelectionSize: 7, elitePreservationStrategy: 'mu_plus_lambda' },
  local: { populationSize: 32, generations: 5, evaluationSeeds: Array.from({ length: 5 }, (_, i) => `local-${String(i + 1).padStart(3, '0')}`), opponentsPerGenome: 3, matchesPerOpponent: 3, absoluteMaxTicks: 1500, tieBreakerRules: ['hp_percentage', 'total_damage_dealt', 'total_assets'], eliteCount: 4, hallOfFameOpponentCount: 4, mutationRatePermille: 60, crossoverRatePermille: 600, mutationSigmaInitial: 50, mutationSigmaDecay: 0.98, tournamentSelectionSize: 7, elitePreservationStrategy: 'mu_plus_lambda' },
  full: { populationSize: 128, generations: 50, evaluationSeeds: Array.from({ length: 5 }, (_, i) => `full-${String(i + 1).padStart(3, '0')}`), opponentsPerGenome: 3, matchesPerOpponent: 3, absoluteMaxTicks: 1500, tieBreakerRules: ['hp_percentage', 'total_damage_dealt', 'total_assets'], eliteCount: 8, hallOfFameOpponentCount: 8, mutationRatePermille: 60, crossoverRatePermille: 600, mutationSigmaInitial: 50, mutationSigmaDecay: 0.98, tournamentSelectionSize: 7, elitePreservationStrategy: 'mu_plus_lambda' },
};
